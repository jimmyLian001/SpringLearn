	...
	$.extend(Timepicker.prototype, {
		...
		*/
		_controls: {
			...
			spinner: {
				create: function(tp_inst, obj, unit, val, min, max, step){
					$('<input type="text" class="ui-spinner-input" value="'+val+'" >')
						.appendTo(obj)
						.spinner({
							min: min,
							max: max,
				...
				options: function(tp_inst, obj, unit, opts, val){
					if(typeof(opts) == 'string' && val !== undefined)
						return obj.find('.ui-spinner-input').spinner(opts, val);
					return obj.find('.ui-spinner-input').spinner(opts);
				},
				value: function(tp_inst, obj, unit, val){
					if(val !== undefined)
						return obj.find('.ui-spinner-input').spinner('value', val);
					return obj.find('.ui-spinner-input').spinner('value');
				}
			}
		} // end _controls
