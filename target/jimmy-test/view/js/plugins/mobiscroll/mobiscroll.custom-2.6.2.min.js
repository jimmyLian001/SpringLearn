...
k+'"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div aria-live="assertive" class="dwv'+(p.headerText?"":" dw-hidden")+'"></div>')+'<div class="dwcc">';a.each(p.wheels,function(c,k){h+='<div class="dwc'+("scroller"!=p.mode?" dwpm":" dwsc")+(p.showLabel?"":" dwhl")+'"><div class="dwwc dwrc"><table cellpadding="0" cellspacing="0" style="border:0px;"><tr>';a.each(k,function(a,c){la[g]=c;b=void 0!==c.label?c.label:a;h+='<td style="padding:0px;border:0px;background:none;"><div class="dwwl dwrc dwwl'+g+'">'+("scroller"!=
